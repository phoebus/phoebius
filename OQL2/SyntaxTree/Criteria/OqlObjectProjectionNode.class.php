	...
	**/
	final class OqlObjectProjectionNode extends OqlObjectNode
	{
		...
		private static $classMap = array(
			...
			'RowCountProjection'		=> 'rowCount',
			'DistinctCountProjection'	=> 'distinctCount'
		);
		...
		public function toString()
		{
			if ($this->object) {
				...
				if ($this->object instanceof ProjectionChain) {
					...
					if ($this->property instanceof ISqlCastable)
						$result .= $this->property->toDialectString(DummyDialect::getInstance());
					else
					...
					if (
						$this->object instanceof AggrProjection
