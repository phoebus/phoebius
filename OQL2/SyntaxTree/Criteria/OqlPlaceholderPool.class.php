	...
	**/
	final class OqlPlaceholderPool
	{
		...
		**/
		public function get($name)
		{
			...
			Assert::isUnreachable(
				"knows nothing about such placeholder '%s'", $name
			);
		}
		...
		**/
		public function add(OqlPlaceholder $placeholder)
		{
			Assert::isFalse(
				...
				"placeholder named '%s' is already in pool. use spawn to create one.",
				$placeholder->getName()
			);
		...
		**/
		...
		{
			Assert::isTrue($this->has($name), "knows nothing about such placeholder '%s'", $name);
